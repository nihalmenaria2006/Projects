...
from models import ResNetAutoencoder34 as ResNetAutoencoder
# =========================================
# UTILITY FUNCTIONS
# =========================================
def read_img(path):
...
def train_dual_resnet():
    ...
    dataset_root = '/root/wrinkle/Projects/frequency_separation/data/train'
    ...
    dataset_root_val = '/root/wrinkle/Projects/frequency_separation/data/val'
    ...
    dl = DataLoader(ds, batch_size=batch_size, shuffle=True, num_workers=48, pin_memory=True)


    val_dataset = PairedClothDatasetWithMask(wrinkled_dir_val, clean_dir_val, mask_dir_val, size=size, augment=False)
    val_dataloader = DataLoader(val_dataset, batch_size=batch_size, shuffle=False, num_workers=48, pin_memory=True)
